    function LikePost(a,b,c){b=b.replace("http://","");var sArray=b.split("/");c.setAttribute("onclick","");c.setAttribute("style","width:35px; border-radius:35px;");c.setAttribute("src","http://static.tumblr.com/j1tjexd/5YOmanh18/like2.png");document.getElementById("likes_frame").setAttribute("src","http://www.tumblr.com/like/"+sArray[3]+"?id="+a);document.getElementById("note_count_"+a).innerHTML=parseInt(document.getElementById("note_count_"+a).innerHTML)+1;}
